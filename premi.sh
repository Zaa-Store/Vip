...
TIMES="10"
CHATID="7528634696"
KEY="7575047078:AAGTPI1mfbNmLTfJR69DNREi6PAHQBwv0jI"
...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To ZAA STORE SCRIPT ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}ZAA STORE ® ${NC}${YELLOW}(${NC} ${green} ZAA_STORE ${NC}${YELLOW})${NC}"
echo -e " © Recode By NEWBIE ${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
Exp1=$(curl https://raw.githubusercontent.com/Zaa-Store/vip/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/Zaa-Store/vip/main/"
...
restart_system(){
    USRSC=$(curl -sS https://raw.githubusercontent.com/Zaa-Store/vip/main/izin | grep $MYIP | awk '{print $2}')
    EXPSC=$(curl -sS https://raw.githubusercontent.com/Zaa-Store/vip/main/izin | grep $MYIP | awk '{print $3}')
